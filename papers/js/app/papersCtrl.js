define(["angular","underscore","js/app/papers_createApp"],function(angular,_,app){
    ...
    app.controller("papersCtrl",function($scope,$http){
        ...
        $scope.spreadsheetId = (!query) ? "1IxCBjXu1ax7G_t79BKJiEuViK-jAXGAH4qvDJ7zyzck" : query.split("/")[0];
        $scope.spreadsheetJsonUrl = "https://spreadsheets.google.com/feeds/list/1IxCBjXu1ax7G_t79BKJiEuViK-jAXGAH4qvDJ7zyzck/1/public/values?alt=json";
